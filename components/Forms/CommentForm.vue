<template>
    <form v-on:submit.prevent="submitForm" action="form.php" method="post" id="commentform" class="comment-form">
        ...
        <div class="form-group">
            <label for="comment" class="form-label-lg before">Comment *</label>
            <textarea v-model="form.comment" id="comment" class="form-control font-size-lg" name="comment" cols="45" rows="6" required="required"></textarea>
        </div>

        <div class="form-group">
            <label for="comment-author" class="form-label-lg before">Name *</label>
            <input v-model="form.author" id="comment-author" class="form-control font-size-lg" name="comment-author" type="text" required="required">
        </div>

        <div class="form-group">
            <label for="comment-email" class="form-label-lg before">Email *</label>
            <input v-model="form.email" id="comment-email" class="form-control font-size-lg" name="comment-email" type="email" required="required">
        </div>

        <div class="form-group">
            <label for="comment-url" class="form-label-lg before">Website</label>
            <input v-model="form.url" id="comment-url" class="form-control font-size-lg" name="comment-url" type="url">
        </div>
